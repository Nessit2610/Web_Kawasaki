...
<!-- hien thi gio  -->
<%	
	ArrayList<thongsobean> ds = (ArrayList<thongsobean>)request.getAttribute("thongso");
	String anh = (String)request.getAttribute("anh");

%>
<div style="display: flex;margin-top: 20px;margin-bottom: 15px;">
		<div style="font-size: 35px; font-weight: bold; margin-left: 35px;color: #454548;">THÔNG SỐ KỸ THUẬT</div>
	...
	<table border="1" width="100%" class="table table-striped table-bordered table-responsive ">
			<%	int n = ds.size();
				for(int i =0; i<n;i++){ 
					thongsobean tsb = ds.get(i);%>
			<tr class="info">
					<td style="width: 50%;"> 
						<%if(tsb.getMaxe().equals("zx10r")){%>
							<div id="carouselExampleAutoplaying" class="carousel slide" data-bs-ride="carousel">
								  <div class="carousel-inner">
									    <div class="carousel-item active">
									      <img src="Anhtest/1.png" class="d-block w-100" alt="...">
									    </div>
								    
								  <%for(int s = 1; s<=19; s++){%>
										<div class="carousel-item">
									      <img src="Anhtest/<%=s%>.png" class="d-block w-100" alt="...">
									    </div>
									<%}%>
								  </div>
						...
						<%if(!tsb.getMaxe().equals("zx10r")){%>
							<div >
								<img alt="" src="<%=anh%>" style="    width: 100%;">
							</div>
						<%}%>
			       </td>		
					<td style="padding: 0px;"> 
						<div style="line-height: 1.9;">
							<table border="1" width="100%" height="100%" class="table table-striped table-borderless table-responsive " style="margin-bottom: 0px;">
								<tr>
									<td>
									<span class="styletext2">Tên xe : </span><%=tsb.getTenxe() %> <br>
									</td> 
								</tr>
								<tr>
									<td>
										<span class="styletext2">Dung tích động cơ : </span><%=tsb.getDungtich() %> <br>
									</td>
								</tr>
								<tr>
									<td>
										<span class="styletext2">Hộp số : </span><%=tsb.getHopso() %> <br>
									</td>
								</tr>
								<tr>
									<td >
										<span class="styletext2">Loại động cơ : </span><%=tsb.getLoaidongco() %>
									</td>
								</tr>
								<tr>
									<td>
										<span class="styletext2">Chiều cao : </span><%= tsb.getChieucao()%> <br>
									</td>
								</tr>
								<tr>
									<td>
										<span class="styletext2">Trọng lượng xe : </span><%= tsb.getTrongluong()%> <br>
									</td>
								</tr>
								<tr>
									<td>
										<span class="styletext2">Bảo Hành : </span><%= tsb.getBaohanh()%> <br>
									</td>
								</tr>
								<tr>
									<td>
										<form action="giohangController?Mathongso=<%=tsb.getMaxe()%>" method="post">
											<button class="btn btn-outline-success" name="themgio" type="submit">Thêm vào giỏ hàng </button>
										</form>
									</td>
								</tr>
							</table>	
